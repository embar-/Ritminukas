...
t=uitable(f,'data',LC_TXT,'ColumnName',k , 'Units', 'normalized', 'position', [0.02 0.15 0.96 0.8],'ColumnEditable',l,'tag','lentele', 'userdata',LC_info,...
    'CellEditCallback','LC_TXT=get(findobj(gcf,''tag'',''lentele''),''data''); LC_info=get(findobj(gcf,''tag'',''lentele''),''userdata''); save(get(gcf,''name''),''LC_info'', ''LC_TXT'') ; clear(''r_lokaliz'');');
set(t,'units','pixels');
